...
/**
 * Objeto SerieGold "Real" para obtener de la bbdd los datos mediante la estrategia lazy load
 *
 */
public class SerieGoldReal extends Serie {
	 ...
	 * @param sinopsis
	 */
	public SerieGoldReal(String nombre, String sinopsis) {
