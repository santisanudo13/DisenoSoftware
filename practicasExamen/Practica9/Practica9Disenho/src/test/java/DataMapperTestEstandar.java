...
import proxy.SerieEstandarReal;
/**
 * Prueba del data mapper de Series
 *
 */
public class DataMapperTestEstandar {
	...
	public void testInsert() throws NoSeHaPodidoConectarABBDD {
		...
		Serie serie = new SerieEstandarReal("House of Cards", "Bla, bla, bla...");
	...
	public void testUpdate() throws NoSeHaPodidoConectarABBDD {
		...
		SerieDataMapper serieDataMapper = new SerieDataMapper();
		Serie serie = new SerieEstandarReal("House of Cards", "House of Cards es una serie, bla, bla, bla...");
	...
	public void testSelect() throws NoSeHaPodidoConectarABBDD {
		...
		Serie serie = new SerieEstandarReal("La que se avecina", "Bla, bla, bla...");
		serie = serieDataMapper.insertSerie(serie);
	...
	public void testDelete() throws NoSeHaPodidoConectarABBDD {
		...
		Serie serie = new SerieEstandarReal("Narcos", "Bla, bla, bla...");
		serie = serieDataMapper.insertSerie(serie);
	...
	public static void prepareDataForLazyLoadTest() throws NoSeHaPodidoConectarABBDD, SQLException{
		String sql = "INSERT INTO p09diseno.Serie(idSerie,nombre,sinopsis,costoSerie,tipoSerie,idCreador) VALUES(0,'Serie Prueba Lazy Load','bla,bla,bla',0.75,'Estandar',0)"
