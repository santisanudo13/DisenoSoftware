...
namespace CompositeSparrowEnlaces
{
    ...
    public class EnlaceDirecto : ElementoSistemaFicheros
    {
        ...
        {
            ElementoSistemaFicheros fichero = (ElementoSistemaFicheros)elementoDestino;
            fichero.RegistrarObserver(new ObserverEnlaceDirecto(this));
            this.elementoDestino = elementoDestino;
            Nombre = elementoDestino.Nombre;
        }
