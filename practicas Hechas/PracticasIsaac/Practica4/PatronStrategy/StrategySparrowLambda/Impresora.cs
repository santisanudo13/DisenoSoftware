...
namespace StrategySparrowLambda
{
    ...
    public abstract class Impresora
    {
        ...
        public abstract String imprimirArchivoComprimido(ArchivoComprimido comprimido, Func<String, String> visualizacion);
        ...
        public abstract String imprimirEnlace(EnlaceDirecto enlace, Func<String, String> visualizacion);
    }
}
