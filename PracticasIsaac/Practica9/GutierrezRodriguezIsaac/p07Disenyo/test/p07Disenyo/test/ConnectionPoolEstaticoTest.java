...
import p07Disenyo.EstrategiaEstatica;
import p07Disenyo.excepciones.NoSeHaPodidoConectarABBDD;

/**
 * Clase de pruebas para la estrategia estatica
 * @author Isaac Gutierrez Rodriguez
 *
 */
public class ConnectionPoolEstaticoTest {

	@Test
	public void testObtenerConexion() throws NoSeHaPodidoConectarABBDD {
		int numMaxConexiones = 5;

		Estrategia estrategia = new EstrategiaEstatica(numMaxConexiones);
