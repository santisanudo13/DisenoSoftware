using System;
using AbstractFactorySparrowPrototype.SistemaFicheros;
using AbstractFactorySparrowPrototype.Impresoras;
using AbstractFactorySparrowPrototype.Factorias;
...
{
    /// <summary>
    /// Programa de Pruebas para la estrategia extendida abierta
    /// </summary>
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            FactoriaConcretaVisualizacionAbierta.setVisualizacion(new VisualizacionGallega());

            AbstractFactoryVisualizacion factoriaAbierta = FactoriaConcretaVisualizacionAbierta.getInstance();
            Visualizacion visualizacionAbierta = factoriaAbierta.crearVisualizacion();
            Impresora impresoraExtendidaAbierta = factoriaAbierta.crearImpresora(visualizacionAbierta);
            Console.Out.Write(impresoraExtendidaAbierta.imprimirDirectorio(raiz));
