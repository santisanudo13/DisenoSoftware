...
namespace AbstractFactorySparrowPrototype.Impresoras
{ 
    /// <summary>
    ...
    public class ImpresoraCompacta : Impresora
    {
        ...
        public ImpresoraCompacta(Visualizacion estrategia) : base(estrategia) { }
        ...
        {
            return Estrategia.visualizacion("c " + comprimido.Nombre + "\n");
        }
