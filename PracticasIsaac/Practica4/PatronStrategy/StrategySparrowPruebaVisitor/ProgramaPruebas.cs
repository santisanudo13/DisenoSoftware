...
namespace StrategySparrowPruebaVisitor
{
    /// <summary>
    ...
    public class ProgramaPruebas
    {
        public static void Main(string[] args)
        {
            ...
            Impresora impresoraCompacta = new ImpresoraCompacta(new VisualizacionCastellano());
            ...
            Impresora impresoraExtendida = new ImpresoraExtendida(new VisualizacionCastellano());
